...
var FullCalendar = (function (e) {
    ...
    function ao(e) {
        return p(
            ...
            p("div", { className: "fc-event-title-container" }, p("div", { className: "fc-event-title fc-sticky" }, e.event.title || p(y, null, "Â ")))
        );
    }
    const lo = (e) =>
    ...
    function ll(e) {
        return p(
            ...
            e.timeText && p("div", { className: "fc-event-time" }, e.timeText),
            p("div", { className: "fc-event-title" }, e.event.title || p(y, null, "Â "))
        );
    }
    class cl extends Gn {
        constructor() {
                ...
                (s, a) =>
                    p(
                        ...
                        !a.isDisabled && (t.showDayNumber || ho(i) || t.forceDayTop)
                            ...
                            : t.showDayNumber
                                ? p("div", { className: "fc-daygrid-day-top", style: { visibility: "hidden" } }, p("a", { className: "fc-daygrid-day-number" }, "Â "))
                                : void 0,
                        p(
                            "div",
